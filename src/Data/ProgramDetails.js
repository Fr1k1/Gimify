...
export const programDetails = [
  {
    ...
    description:
      "Ovaj program namijenjen je za ljude koji žele brzo ojačati i izgledati što bolje za što kraće vrijeme obzirom da se uz pravilnu prehranu i pravilno treniranje može lakoupravljati nečijom masom.",

    list_items: [
      "Već nakon nekoliko dana vidi se napredak",
      "Brzo dobivanje mase",
      "Razvijanje mišića",
    ],
...

  {
    ...
    description:
      "Ovaj program namijenjen je za ljude koji žele steći kondiciju i za one koji ne mogu trčati.",

    list_items: ["Steknite kondiciju", "Naučite pravilno disati i trčati"],
...

  {
    ...
    description:
      "Naučite više o pravilnom disanju, kretanju i zdravom načinu života.",
...

  {
    ...
    description:
      "Naučite više o zdravoj i pravilnoj prehrani, skidanju kilograma i kako biti fit.",
