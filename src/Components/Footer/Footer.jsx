...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    if (currentPage.includes("gallery")) setMarginValue("2rem");
    if (currentPage.includes("contact")) setMarginValue("-2rem");
  }, [setMarginValue]);
  ...
  return (
    <div id="footer_div" style={{ top: marginTop, position: "relative" }}>
      ...
      <div id="main_footer">
        ...
        <div id="icons">
          <a
            href="https://www.instagram.com/martinfriscic/"
            rel="noreferrer"
            target={"_blank"}
          >
            {" "}
          ...
          <a href="https://github.com/Fr1k1" rel="noreferrer" target={"_blank"}>
            {" "}
